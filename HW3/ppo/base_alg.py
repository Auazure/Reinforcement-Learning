...
class BasePolicyGradient:
    ...
    def _init_hyperparameters(self, hyperparameters):
        ...
        self.stats_file= '/scratch/cj2164/Reinforcement-Learning/HW3/ppo/RF.csv'
    ...
    def _log_summary(self):
        ...
        with open('PPOBW_2001.csv', 'a') as f:  # You will need 'wb' mode in Python 2.x
            writer=csv.writer(f)
            writer.writerow([i_so_far,avg_ep_lens,avg_ep_rews,avg_actor_loss,t_so_far])
