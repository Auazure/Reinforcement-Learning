...
if __name__ == '__main__':
    ...
    parser.add_argument('--alg', dest='alg', type=str, default='PPO')        # Formal name of our algorithm
    parser.add_argument('--seed', dest='seed', type=int, default=2001)             # An int for our seed
    parser.add_argument('--env', dest='env', type=str, default='BipedalWalker-v3')                 # Formal name of environment
